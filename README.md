...
<body>
    <header class="container text-center">
        <img src="img/avatar-perfil.png" alt="avatar do Felipe" class="rounded-circle" width="150" height="150"
            srcset="">
        <p class="lead">Eu sou Felipe Alexandre Ribeiro Matienzo_</p>
        <h1>Eu ensino Musica e estou cursando musica</h1>
        <p>Sou aluno de musica,ensino a teoria e pratica da musica!</p>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Decidindo o Futuro: Uma Jornada Musical e cheia de aprendizados.</h5>
